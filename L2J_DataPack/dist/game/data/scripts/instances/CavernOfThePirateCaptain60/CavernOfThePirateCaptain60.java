 ...
 */
package instances.CavernOfThePirateCaptain60;
 ...
 * @author St3eT
 */
public final class CavernOfThePirateCaptain60 extends AbstractInstance
{
	...
	public CavernOfThePirateCaptain60()
	{
		super(CavernOfThePirateCaptain60.class.getSimpleName());
	...
	public void onEnterInstance(L2PcInstance player, InstanceWorld world, boolean firstEntrance)
	{
		if (firstEntrance)
		{
			...
			curworld._is60 = curworld.getTemplateId() == TEMPLATE_ID_60;
	...
	protected boolean checkConditions(L2PcInstance player)
	{
		...
		if ((members.size() < PLAYERS_60_MIN) || (members.size() > PLAYERS_60_MAX))
		{
		...
		for (L2PcInstance groupMembers : members)
		{
			...
			final Long reentertime = InstanceManager.getInstance().getInstanceTime(groupMembers.getObjectId(), TEMPLATE_ID_60);
			...
			if ((tmpworld != null) && (tmpworld instanceof CavernOfThePirateCaptainWorld))
			{
				...
				switch (event)
				{
					...
					case "SHOW_ZAKEN":
					{
						...
						spawnNpc(DOLL_BLADER_60, world._zakenRoom, player, world);
						spawnNpc(PIRATES_ZOMBIE_60, world._zakenRoom, player, world);
						spawnNpc(PIRATES_ZOMBIE_CAPTAIN_60, world._zakenRoom, player, world);
						break;
					}
				}
			}
	...
	private void manageNpcSpawn(CavernOfThePirateCaptainWorld world)
	{
		...
		world._zaken = spawnNpc(ZAKEN_60, world._zakenRoom, null, world);
